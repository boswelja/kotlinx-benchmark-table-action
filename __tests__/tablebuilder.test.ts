...
describe('tablebuilder', () => {
    it('maps the parsed benchmarks into markdown', () => {
        ...
        expect(result).toBe(expectedOutputTable)
    })
})

const expectedOutputTable = "<table><tr><th>Benchmark</th><th>Score</th><th>Error</th></tr><tr><td>com.benchmarks.MessagesBenchmark.messageInsertionBenchmark</td><td>1.782ops/s</td><td>0.223ops/s</td></tr><tr><td>com.benchmarks.MessagesBenchmark.queryMessagesBenchmark</td><td>50.457ops/s</td><td>3.394ops/s</td></tr></table>"